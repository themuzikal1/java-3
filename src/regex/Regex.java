...
class Regex {
    public static void main(String[] args) {
        ...
        System.out.println("The following pattern ('\\d'){36} matches : one digit exactly 36 times");
        ...
        String bookText = "Books are the keys to knowledge.  I didn't like to read books as a child, " +
                ...
                "such as kindle-books, nook-books, or other e-books. My personal favorite book format are pdf-books, because " +
                "I don't have to carry so many books around wherever I go.  All the books are on my ipad or laptop.  " +
                "When I lived abroad, they would give books to students absolutely free.  Free books for a student of " +
                "knowledge is like a kid in a candy store.  So wipe the dust off of your books, and remember the slogan from 'reading rainbow' : " +
                "'Take a look! It's in a book! Reading Rainbow!";
        System.out.println(bookText);
        System.out.println(bookText.matches("(.*)book(.*)"));
        ...
        String[] sleepys = sleepy.split("sleepy");
        for(String temp: sleepys) {
        ...
        String not_sleepy = Arrays.toString(sleepys); //punctuation marks will be here
        ...
        // unicode arrow symbols to aid you in your search.  Match all the codes that are arrows,
        // and then print them out to the console.  They should be printing out as the arrow images.
